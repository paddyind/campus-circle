...
- **Backups**: Schema and/or data dumps created by `./infra/scripts/run.sh db backup` (e.g. `backup_YYYYMMDD_HHMMSS.sql`).
...
```bash
./infra/scripts/run.sh db restore database/backup/backup_YYYYMMDD_HHMMSS.sql
```
