...
const LoginPage = () => {
  ...
  return (
    <div className="w-full flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50 py-12 px-4 sm:px-6 lg:px-8 min-h-full">
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Or{' '}
            <Link to="/register/parent" className="font-medium text-indigo-600 hover:text-indigo-500">
            ...
            <div className="rounded-md bg-red-50 p-4">
              <div className="flex">
                ...
                <div className="ml-3 flex-1 min-w-0">
                  ...
                  {(error.includes('fetch') || error.includes('network') || error.toLowerCase().includes('failed')) && (
                    <p className="text-xs text-gray-600 mt-1 break-all">
                      API: <code className="bg-gray-100 px-1 rounded">{getApiBaseDisplayUrl()}</code> — ensure backend is running and reachable from this device.
                    </p>
                  )}
                </div>
              </div>
